...
topic_path=/usr/local/KafkaScripts/util/kafka_2.13-3.2.0/bin/
#kafka_topics_path=/usr/local/KafkaScripts/util/kafka_2.13-3.2.0/bin/kafka-console-consumer.sh
kafka_topics_path2=/usr/local/KafkaScripts/util/kafka_2.13-3.2.0/bin/kafka-topics.sh
#TextFile=/usr/local/KafkaScripts/util/kafka_2.13-3.2.0/bin/TopicsTextFile/
